...
class TestAPIServer(AioHTTPTestCase):
    ...
    async def test_api_index_request(self):
        ...
        request = await self.client.request(
            "GET", "/?key=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyIjoidGFubmVyX293bmVyIn0."
    ...
    async def test_api_snares_request(self):
        ...
        request = await self.client.request(
            "GET", "/snares?key=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9"
    ...
    async def test_api_snare_info_request(self):
        ...
        request = await self.client.request(
            "GET", "/snare/8fa6aa98-4283-4085-bfb9-a1cd3a9e56e4"
    ...
    async def test_api_snare_stats_request(self):
        ...
        request = await self.client.request(
            "GET", "/snare-stats/8fa6aa98-4283-4085-bfb9-a1cd3a9e56e4?key=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9"
            ".eyJ1c2VyIjoidGFubmVyX293bmVyIn0.NQ7x_iq2t2SUs20Z9G-FmgqeNBOp5duiXr_auNVmzfU"
        )
        assert request.status == 200
        detection = await request.json()
    ...
    async def test_api_sessions_info_request(self):
        ...
        request = await self.client.request(
            "GET", "/session/4afd45d61b994d9eb3ba20faa81a45e1?key=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9"
            ".eyJ1c2VyIjoidGFubmVyX293bmVyIn0.NQ7x_iq2t2SUs20Z9G-FmgqeNBOp5duiXr_auNVmzfU"
        )
        assert request.status == 200
        detection = await request.json()
