...
class TestWebServer(AioHTTPTestCase):
    ...
    async def test_handle_snares(self):
        ...
        self.expected_content = '<a href="/snare/9a631aee-2b52-4108-9831-b495ac8afa80">' \
    ...
    async def test_handle_sessions_error(self):
        ...
        with self.assertLogs(level='ERROR') as log:
            response = await self.client.request('GET',
                                             '/8fa6aa98-4283-4085-bfb9-a1cd3a9e56e4/sessions/page/1?filters=start_time:1497890400,peer_ip:127.0.0.1')  # noqa
