...
from tanner.emulators import lfi, rfi, sqli, xss, cmd_exec, php_code_injection, crlf, pad_oracle
...
class BaseHandler:
    def __init__(self, base_dir, db_name, loop=None):
        ...
        self.post_emulators = ['sqli', 'rfi', 'lfi', 'xss', 'php_code_injection', 'cmd_exec', 'crlf', 'pad_oracle']
